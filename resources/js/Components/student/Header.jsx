        ...
        <header className="bg-white shadow-sm sticky top-0 z-50 w-full">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    <nav className="hidden md:flex items-center space-x-8">
                        <a
                            href="/"
                            className="text-gray-900 hover:text-teal-600 px-3 py-2 transition-colors"
                        >
                            Home
                        </a>
                        <a
            ...
            >
                <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-gray-50 shadow-md">
                    <a
                        href="/"
                        className="block px-3 py-2 text-base font-medium text-gray-900 hover:text-teal-600 hover:bg-gray-100 transition-colors"
                    >
                        Home
                    </a>
                    <a
