...
const AlertError = ({ message, onClose }) => {
  return (
    <div className="fixed bottom-4 right-4 z-50">
      <div className="bg-red-50 dark:bg-red-900 dark:bg-opacity-20 border-l-4 border-red-500 dark:border-red-400 rounded-r-lg p-4 shadow-lg">
        <div className="flex">
