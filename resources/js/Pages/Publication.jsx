...
const Publication = () => {
  ...
  const handleClickAddNewPublication = () => {
    ...
    <div className="p-6">
      <div className='flex justify-between'>
        <div className="flex flex-col justify-start items-start mb-6">
          ...
          <p className="text-gray-600">Manage your courses, TDs, TPs and other publications</p>
        </div>
        <div>
          <button 
            onClick={handleClickAddNewPublication}
            type="button" class="inline-flex items-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
          <svg
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        ...
        <div className="p-4 border-b border-gray-200">
          <div className="flex justify-between items-center">
            ...
            />
            <select className="pr-30 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
