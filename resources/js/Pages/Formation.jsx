...
const Formations = () => {
        ...
        const fetchFormations = async () => {
            ...
            try {
                ...
                const withSearchProps = formattedData.map((formation) => ({
                    ...
                    searchableStatus: formation.published
                        ? "published"
                        : "draft",
                }));
    ...
    const handleDelete = async (id) => {
        if (window.confirm("Are you sure you want to delete this formation?")) {
            try {
                const response = await axios.post("/api/formations/delete", {
                    id,
                });
    ...
    const handleFormationDetaille = (id_formation) => {
        router.get(route("formationDetails", { id_formation }));
    };
